...
import lib.pulltorefresh.ILoadingLayout;
	...
	public LoadingLayout(Context context, final Mode mode,
		...
		case HORIZONTAL:
			LayoutInflater.from(context).inflate(
					R.layout.lib_pull_refresh_header_horizontal, this);
			break;
		case VERTICAL:
		default:
			LayoutInflater.from(context).inflate(
					R.layout.lib_pull_refresh_header_vertical, this);
			break;
		}
		...
		// custom for PullJustLoadingLayout
		if (attrs != null) {

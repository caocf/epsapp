...
public final class CameraManager {
	...
	private static int MAX_FRAME_WIDTH = 380;
	private static int MAX_FRAME_HEIGHT = 360;
	// private static final int MAX_FRAME_WIDTH = 280;
	...
	private CameraManager(Context context) {
		...
		int max = configManager.getMaxFrameWidth();
		if (max > 100) {
			this.MAX_FRAME_WIDTH = MAX_FRAME_HEIGHT = max;
		}

...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		paint = new Paint();
		maskColor = Color.argb(0x60, 0x00, 0x00, 0x00);
		resultColor = Color.argb(0xB0, 0x00, 0x00, 0x00);
		resultPointColor = Color.argb(0xc0, 0xff, 0xff, 0x00);
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawBitmap(((BitmapDrawable) (getResources()
					.getDrawable(R.drawable.zxing_scan_line))).getBitmap(),
					null, lineRect, paint);

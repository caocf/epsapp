...
public abstract class NetComplaintById extends NetRequestor<LogisticsReq.Builder, CommonLogisticsResp.Builder> {

	@Override
	protected int getCommandCode() {
		return CommandConstants.GET_COMPLAINT_BY_ID_REQ;
	}

...
public abstract class NetUpdateComplaint extends NetRequestor<LogisticsReq.Builder, CommonLogisticsResp.Builder> {

	@Override
	protected int getCommandCode() {
		return CommandConstants.UPDATE_COMPLAINT_STATUS_REQ;
	}

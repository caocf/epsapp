...
public abstract class NetComplaintsList extends NetRequestor<LogisticsReq.Builder, CommonLogisticsResp.Builder> {

	@Override
	protected int getCommandCode() {
		return CommandConstants.LIST_COMPLAINTS_REQ;
	}

...
import com.epeisong.ui.fragment.BlackBoardFragment;
...
*//**
 * 
 * @author 孙灵洁 我的货源详情(搜索，发布小黑板)
 * 
 *//*
public class MySupplyDetailsActivity extends BaseActivity implements
...
//	private LinearLayout bt_immediately_consult;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		super.setContentView(R.layout.activity_my_supply_details);
...
//		bt_immediately_consult.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		case R.id.bt_immediately_consult:
			Intent intent2 = new Intent(MySupplyDetailsActivity.this,

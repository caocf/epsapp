 ...
 *
 */
public class ChooseSpecificContactsActivity extends BaseActivity implements OnChildClickListener, OnClickListener,
			...
			public void onCheckedChanged(CompoundButton arg0, boolean arg1) {
				...
				if( arg1 ) {
					...
					for(int i=0;i<count;i++) {
						int ccount = mAdapter.getChildrenCount(i);
						for(int j=0;j<ccount;j++) {
							Contacts c=mAdapter.getChild(i, j);
							mContactsSelectedList.add(c);
						}
					}
				}
    ...
    public void onClick(View v) {
        switch (v.getId()) {
        case R.id.et_search:
            Intent intent = new Intent(this, ChooseSSearchContactsActivity.class);
            intent.putExtra(ChooseSSearchContactsActivity.EXTRA_ORIGINAL_CONTACTS_LIST, mContactsOriginalList);
            intent.putExtra(ChooseSSearchContactsActivity.EXTRA_FILTER_CONTACTS_IDS, mContactsIdsFilter);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == 1 && data != null) {
            ArrayList<Contacts> mContactsSelectedList = (ArrayList<Contacts>) data
                    .getSerializableExtra(ChooseSSearchContactsActivity.EXTRA_ORIGINAL_CONTACTS_LIST);

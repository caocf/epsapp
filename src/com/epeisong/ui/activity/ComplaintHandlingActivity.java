...
import com.epeisong.ui.fragment.ComplaintListFragment;
import com.epeisong.ui.fragment.ComplaintRecordFragment;
 ...
 *
 */
public class ComplaintHandlingActivity extends TabPages2Activity {
...
//		CustomerProblemUntreatFragment mFragment = new CustomerProblemUntreatFragment();
		ComplaintListFragment mFragment = new ComplaintListFragment();
		mFragments.add(mFragment);
		
		ComplaintRecordFragment sFragment = new ComplaintRecordFragment();
	...
	protected TitleParams getTitleParams() {
		return new TitleParams(getDefaultHomeAction(), "投诉处理", null).setShowLogo(false);
	}

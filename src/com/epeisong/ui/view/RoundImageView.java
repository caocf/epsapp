...
public class RoundImageView extends ImageView {
    ...
    private boolean mUseRound = true;
    ...
    public void setUserRound(boolean use) {
        mUseRound = use;
    }
    ...
    public Bitmap getCroppedBitmap(Bitmap bmp, int radius) {
        ...
        canvas.drawCircle(sbmp.getWidth() / 2 + 0.7f, sbmp.getHeight() / 2 + 0.7f, sbmp.getWidth() / 2.1f + 0.1f, paint);
